...
while True:
    ...
    if ball.xcor() > 390:
        ...
        score_a += 1
        pen.clear()
        pen.write("Player A: {}  Player B: {}".format(score_a, score_b), align="center".format(score_a, score_b), font=("Courier", 24, "normal"))
    ...
    if ball.xcor > ball2.xcor():
        ...
        elif paddle_a.ycor() > ball.ycor() and abs(paddle_b.ycor() - ball.ycor()) > 10:
        paddle_b_down()
        ...
        elif paddle_a.ycor() > ball2.ycor() and abs(paddle_b.ycor() - ball2.ycor()) > 10:
        paddle_b_down()